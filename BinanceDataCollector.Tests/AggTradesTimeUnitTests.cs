...
public sealed class AggTradesTimeUnitTests
{
    ...
    private sealed class TestStorageController : StorageController<object>
    {
        ...
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.Kline>>> GetKlinesAsync(object symbol, Binance.Net.Enums.KlineInterval interval, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.PremiumIndexKline>>> GetPremiumIndexKlinesAsync(object symbol, Binance.Net.Enums.KlineInterval interval, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.PremiumIndexKline>>> GetIndexPriceKlinesAsync(object symbol, Binance.Net.Enums.KlineInterval interval, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.PremiumIndexKline>>> GetMarkPriceKlinesAsync(object symbol, Binance.Net.Enums.KlineInterval interval, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.FundingRate>>> GetFundingRatesAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.OpenInterestHistory>>> GetOpenInterestHistoriesAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.LongShortRatioCsv>>> GetTopLongShortPositionRatiosAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.LongShortRatioCsv>>> GetTopLongShortAccountRatiosAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.LongShortRatioCsv>>> GetGlobalLongShortAccountRatiosAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.TakerLongShortRatioCsv>>> GetTakerLongShortRatiosAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
        protected override Task<FluentResults.Result<IReadOnlyList<CollectorModels.Models.Storage.FuturesBasisCsv>>> GetBasisAsync(object symbol, DateTime startTime, CancellationToken ct = default) => throw new NotSupportedException();
    }
}
